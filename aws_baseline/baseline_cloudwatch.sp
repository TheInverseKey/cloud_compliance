...
control "cloudwatch_cis_v200_4_2" {
  ...
  description   = "Real-time monitoring of API calls can be achieved by directing CloudTrail Logs to CloudWatch Logs, or an external Security information and event management (SIEM) environment, and establishing corresponding metric filters and alarms."
  severity      = "high"
  sql           = aws_compliance.query.log_metric_filter_console_login_mfa.sql
}
...
control "cloudwatch_cis_v200_4_3" {
  ...
  description   = "Real-time monitoring of API calls can be achieved by directing CloudTrail Logs to CloudWatch Logs, or an external Security information and event management (SIEM) environment, and establishing corresponding metric filters and alarms."
  severity      = "high"
  sql           = aws_compliance.query.log_metric_filter_root_login.sql
}
...
control "cloudwatch_cis_v200_4_4" {
  ...
  severity      = "high"
  sql           = aws_compliance.query.log_metric_filter_iam_policy.sql
}
...
control "cloudwatch_cis_v200_4_5" {
  ...
  severity      = "high"
  sql           = aws_compliance.query.log_metric_filter_cloudtrail_configuration.sql
}
...
control "cloudwatch_cis_v200_4_6" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.log_metric_filter_console_authentication_failure.sql
}
...
control "cloudwatch_cis_v200_4_7" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.log_metric_filter_disable_or_delete_cmk.sql
}
...
control "cloudwatch_cis_v200_4_8" {
  ...
  severity      = "high"
  sql           = aws_compliance.query.log_metric_filter_bucket_policy.sql
}
...
control "cloudwatch_cis_v200_4_9" {
  ...
  severity      = "high"
  sql           = aws_compliance.query.log_metric_filter_config_configuration.sql
}
...
control "cloudwatch_cis_v200_4_10" {
  ...
  severity      = "high"
  sql           = aws_compliance.query.log_metric_filter_security_group.sql
}
...
control "cloudwatch_cis_v200_4_11" {
  ...
  severity      = "high"
  sql           = aws_compliance.query.log_metric_filter_network_acl.sql
}
...
control "cloudwatch_cis_v200_4_12" {
  ...
  severity      = "high"
  sql           = aws_compliance.query.log_metric_filter_network_gateway.sql
}
...
control "cloudwatch_cis_v200_4_13" {
  ...
  severity      = "high"
  sql           = aws_compliance.query.log_metric_filter_route_table.sql
}
