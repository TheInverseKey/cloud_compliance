...
control "ecr_1" {
  ...
  severity      = "high"
  query         = aws_compliance.query.ecr_repository_image_scan_on_push_enabled
}
...
control "ecr_2" {
  ...
  severity      = "medium"
  query         = aws_compliance.query.ecr_repository_tag_immutability_enabled
}
...
control "ecr_3" {
  ...
  severity      = "medium"
  query         = aws_compliance.query.ecr_repository_lifecycle_policy_configured
}
