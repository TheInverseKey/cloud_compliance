...
control "codebuild_1" {
  ...
  severity      = "critical"
  sql           = aws_compliance.query.codebuild_project_source_repo_oauth_configured.sql
}
...
control "codebuild_2" {
  ...
  severity      = "critical"
  sql           = aws_compliance.query.codebuild_project_plaintext_env_variables_no_sensitive_aws_values.sql
}
...
control "codebuild_3" {
  ...
  severity      = "low"
  sql           = aws_compliance.query.codebuild_project_s3_logs_encryption_enabled.sql
}
...
control "codebuild_4" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.codebuild_project_logging_enabled.sql
}
...
control "codebuild_5" {
  ...
  severity      = "high"
  sql           = aws_compliance.query.codebuild_project_environment_privileged_mode_disabled.sql
}
