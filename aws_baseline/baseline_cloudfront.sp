...
control "cloudfront_1" {
  ...
  severity      = "critical"
  sql           = aws_compliance.query.cloudfront_distribution_default_root_object_configured.sql
}
...
control "cloudfront_2" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.cloudfront_distribution_origin_access_identity_enabled.sql
}
...
control "cloudfront_3" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.cloudfront_distribution_encryption_in_transit_enabled.sql
}
...
control "cloudfront_4" {
  ...
  severity      = "low"
  sql           = aws_compliance.query.cloudfront_distribution_configured_with_origin_failover.sql
}
...
control "cloudfront_5" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.cloudfront_distribution_logging_enabled.sql
}
...
control "cloudfront_6" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.cloudfront_distribution_waf_enabled.sql
}
...
control "cloudfront_7" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.cloudfront_distribution_use_custom_ssl_certificate.sql
}
...
control "cloudfront_8" {
  ...
  severity      = "low"
  sql           = aws_compliance.query.cloudfront_distribution_sni_enabled.sql
}
...
control "cloudfront_9" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.cloudfront_distribution_custom_origins_encryption_in_transit_enabled.sql
}
...
control "cloudfront_10" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.cloudfront_distribution_no_deprecated_ssl_protocol.sql
}
...
control "cloudfront_12" {
  ...
  severity      = "high"
  sql           = aws_compliance.query.cloudfront_distribution_no_non_existent_s3_origin.sql
}
