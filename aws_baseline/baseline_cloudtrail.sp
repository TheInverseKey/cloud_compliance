...
control "cloudtrail_cis_3.1" {
  ...
  sql           = aws_compliance.query.cloudtrail_multi_region_read_write_enabled
}
...
control "cloudtrail_1" {
  ...
  severity      = "high"
  sql           = aws_compliance.query.cloudtrail_multi_region_trail_enabled
}
...
control "cloudtrail_2" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.cloudtrail_trail_logs_encrypted_with_kms_cmk
}
...
control "cloudtrail_4" {
  ...
  severity      = "low"
  sql           = aws_compliance.query.cloudtrail_trail_validation_enabled
}
...
control "cloudtrail_5" {
  ...
  severity      = "low"
  sql           = aws_compliance.query.cloudtrail_trail_integrated_with_logs
}
...
control "cloudtrail_cis_3.3" {
  ...
  severity      = "high"
  sql           = aws_compliance.query.cloudtrail_bucket_not_public
}
...
control "cloudtrail_cis_3.6" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.cloudtrail_s3_logging_enabled
}
