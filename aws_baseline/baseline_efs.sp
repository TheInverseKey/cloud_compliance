...
control "efs_1" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.efs_file_system_encrypt_data_at_rest
}
...
control "efs_2" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.efs_file_system_automatic_backups_enabled
}
...
control "efs_3" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.efs_access_point_enforce_root_directory
}
...
control "efs_4" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.efs_access_point_enforce_user_identity
}
