...
control "autoscaling_1" {
  ...
  severity      = "low"
  sql           = aws_compliance.query.autoscaling_group_with_lb_use_health_check
}
...
control "foundational_security_autoscaling_2" {
  ...
  severity      = "medium"
  query         = aws_compliance.query.autoscaling_group_multiple_az_configured
}
...
control "foundational_security_autoscaling_3" {
  ...
  severity      = "high"
  sql           = aws_compliance.query.autoscaling_launch_config_requires_imdsv2
}
...
control "foundational_security_autoscaling_4" {
  ...
  severity      = "high"
  sql           = aws_compliance.query.autoscaling_launch_config_hop_limit
}
...
control "foundational_security_autoscaling_5" {
  ...
  severity      = "high"
  sql           = aws_compliance.query.autoscaling_launch_config_public_ip_disabled
}
...
control "foundational_security_autoscaling_6" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.autoscaling_use_multiple_instance_types_in_multiple_az
}
...
control "foundational_security_autoscaling_9" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.autoscaling_group_uses_ec2_launch_template
}
