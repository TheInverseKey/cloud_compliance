...
control "dynamodb_1" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.dynamodb_table_auto_scaling_enabled.sql
}
...
control "dynamodb_2" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.dynamodb_table_point_in_time_recovery_enabled.sql
}
...
control "dynamodb_3" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.dax_cluster_encryption_at_rest_enabled.sql
}