...
control "ec2_1" {
  ...
  severity      = "critical"
  query         = aws_compliance.query.ebs_snapshot_not_publicly_restorable
}
...
control "ec2_2" {
  ...
  severity      = "high"
  query         = aws_compliance.query.vpc_default_security_group_restricts_all_traffic
}
...
control "ec2_3" {
  ...
  severity      = "medium"
  query         = aws_compliance.query.ebs_attached_volume_encryption_enabled
}
...
control "ec2_4" {
  ...
  severity      = "medium"
  query         = aws_compliance.query.ec2_stopped_instance_30_days
...
control "ec2_6" {
  ...
  severity      = "medium"
  query         = aws_compliance.query.vpc_flow_logs_enabled
}
...
control "ec2_7" {
  ...
  severity      = "medium"
  query         = aws_compliance.query.ec2_ebs_default_encryption_enabled
}
...
control "ec2_8" {
  ...
  severity      = "high"
  query         = aws_compliance.query.ec2_instance_uses_imdsv2
}
...
control "ec2_9" {
  ...
  severity      = "high"
  query         = aws_compliance.query.ec2_instance_not_publicly_accessible
}
...
control "ec2_10" {
  ...
  severity      = "medium"
  query         = aws_compliance.query.vpc_configured_to_use_vpc_endpoints
}
...
control "ec2_15" {
  ...
  severity      = "medium"
  query         = aws_compliance.query.vpc_subnet_auto_assign_public_ip_disabled
}
...
control "ec2_16" {
  ...
  severity      = "low"
  query         = aws_compliance.query.vpc_network_acl_unused
}
...
control "ec2_17" {
  ...
  severity      = "low"
  query         = aws_compliance.query.ec2_instance_not_use_multiple_enis
}
...
control "ec2_18" {
  ...
  severity      = "high"
  query         = aws_compliance.query.vpc_security_group_allows_ingress_authorized_ports
}
...
control "ec2_19" {
  ...
  severity      = "medium"
  query         = aws_compliance.query.vpc_security_group_restricted_common_ports
}
...
control "ec2_20" {
  ...
  severity      = "medium"
  query         = aws_compliance.query.vpc_vpn_tunnel_up
}
...
control "ec2_21" {
  ...
  severity      = "medium"
  query         = aws_compliance.query.vpc_network_acl_remote_administration
}
...
control "ec2_22" {
  ...
  severity      = "medium"
  query         = aws_compliance.query.vpc_security_group_unused
}
...
control "ec2_23" {
  ...
  severity      = "high"
  query         = aws_compliance.query.ec2_transit_gateway_auto_cross_account_attachment_disabled
}
...
control "ec2_24" {
  ...
  severity      = "medium"
  query         = aws_compliance.query.ec2_instance_virtualization_type_no_paravirtual
}
...
control "ec2_25" {
  ...
  severity      = "high"
  query         = aws_compliance.query.ec2_launch_template_not_publicly_accessible
}
...
control "ec2_cis_v200_5_2" {
  ...
  query         = aws_compliance.query.vpc_security_group_remote_administration_ipv4
}
...
control "ec2_cis_v200_5_3" {
  ...
  query         = aws_compliance.query.vpc_security_group_remote_administration_ipv6
}
...
control "ec2_cis_v200_5_5" {
  ...
  query         = aws_compliance.query.manual_control
}