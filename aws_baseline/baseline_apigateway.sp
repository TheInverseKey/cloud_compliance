...
control "api_gateway_control_1" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.apigateway_stage_logging_enabled
}
...
control "api_gateway_control_2" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.apigateway_rest_api_stage_use_ssl_certificate
}
...
control "api_gateway_control_3" {
  ...
  severity      = "low"
  sql           = aws_compliance.query.apigateway_rest_api_stage_xray_tracing_enabled
}
...
control "api_gateway_control_4" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.apigateway_stage_use_waf_web_acl
}
...
control "api_gateway_control_5" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.apigateway_stage_cache_encryption_at_rest_enabled
}
...
control "api_gateway_control_8" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.api_gatewayv2_route_authorization_type_configured
}
...
control "api_gateway_control_9" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.gatewayv2_stage_access_logging_enabled
}
