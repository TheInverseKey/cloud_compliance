...
control "elasticache_1" {
  ...
  severity      = "high"
  sql           = aws_compliance.query.elasticache_redis_cluster_automatic_backup_retention_15_days
}
...
control "elasticache_2" {
  ...
  severity      = "high"
  sql           = aws_compliance.query.elasticache_cluster_auto_minor_version_upgrade_enabled
}
...
control "elasticache_3" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.elasticache_replication_group_auto_failover_enabled
}
...
control "elasticache_4" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.elasticache_replication_group_encryption_at_rest_enabled
}
...
control "elasticache_5" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.elasticache_replication_group_encryption_in_transit_enabled
}
...
control "elasticache_6" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.elasticache_replication_group_redis_auth_enabled
}
...
control "elasticache_7" {
  ...
  severity      = "high"
  sql           = aws_compliance.query.elasticache_cluster_no_default_subnet_group
}
