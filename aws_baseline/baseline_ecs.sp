...
control "ecs_1" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.ecs_task_definition_user_for_host_mode_check.sql
}
...
control "ecs_2" {
  ...
  severity    = "high"
  sql         = aws_compliance.query.ecs_service_not_publicly_accessible.sql
}
...
control "ecs_3" {
  ...
  severity      = "high"
  sql           = aws_compliance.query.ecs_task_definition_no_host_pid_mode.sql
}
...
control "ecs_4" {
  ...
  severity      = "high"
  sql           = aws_compliance.query.ecs_task_definition_container_non_privileged.sql
}
...
control "ecs_5" {
  ...
  severity      = "high"
  sql           = aws_compliance.query.ecs_task_definition_container_readonly_root_filesystem.sql
}
...
control "ecs_8" {
  ...
  severity      = "high"
  sql           = aws_compliance.query.ecs_task_definition_container_environment_no_secret.sql
}
...
control "ecs_10" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.ecs_service_fargate_using_latest_platform_version.sql
}
...
control "ecs_12" {
  ...
  severity      = "medium"
  sql           = aws_compliance.query.ecs_cluster_container_insights_enabled.sql
}
